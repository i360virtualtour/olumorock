...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'olumo_rock_i360_virtual_tourdata/olumo_rock_i360_virtual_tour_messages_','.xml');
	krpanoLoaded = true;
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'olumo_rock_i360_virtual_tourdata/olumo_rock_i360_virtual_tour_messages_','.xml');
}
...
function addKolorArea(pPlugID)
{
	...
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/KolorArea/KolorArea.min.js", [], true);
...
function addKolorFloorPlan(pPlugID, pContent)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorFloorPlanCSS = new ktools.CssStyle("KolorFloorPlanCSS", crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/KolorFloorPlan/kolorFloorPlan.css");
		var kolorFloorPlanJS = new ktools.Script("KolorFloorPlanJS", crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/KolorFloorPlan/KolorFloorPlan.min.js", [], true);
...
function showKolorFloorPlan(pPlugID, pContent)
{
	...
	if(!kolorFloorPlan.isReady())
	{
		...
		//set url for images
		kolorFloorPlan.setGraphicsUrl(crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/"+pPlugID.toLowerCase()+"/");
...
function addKolorBox(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"olumo_rock_i360_virtual_tourdata/graphics/KolorBox/KolorBox.min.js", [], true);
